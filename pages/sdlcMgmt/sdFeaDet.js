...
import Component from "../../components/sdlcMgmt/sdFeaDet";
import SdlcFeaHelper from "../../helper/sdlcMgmt/sdFeaDet";
// import alias_name from "../../helper/helper_source_name"
import TimelineComponent from "../../components/sdlcMgmt/sdFeaDetAudit";
...
//	document.addEventListener('contextmenu', (e) => {e.preventDefault();});
  ...
  getPageDet(filter) {
    ...
    SdlcFeaHelper.getPageDet(filter)
      .then((data) => {
  ...
  getFilteredData(filter) {
    SdlcFeaHelper.getFilteredData(filter)
      .then((data) => {
        this.setState({
          arr_exportData: data,
          columnHeaders: {
                  ...
                  c.clm_export == 13 && (
                    <div className={styles.excelcontainer}>
                      <ExportExcel
                        ...
                        fileName={"sdFeaDet_" + moment().format("DDMMYYhhmmss")}
