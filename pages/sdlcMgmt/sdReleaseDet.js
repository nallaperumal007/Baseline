...
import Component from "../../components/sdlcMgmt/sdReleaseDet";
import sdlcReleaseHelper from "../../helper/sdlcMgmt/sdReleaseDet";
// import alias_name from "../../helper/helper_source_name"
import TimelineComponent from "../../components/sdlcMgmt/sdReleaseDetAudit";
...
//	document.addEventListener('contextmenu', (e) => {e.preventDefault();});
  ...
  getPageDet(filter) {
    ...
    sdlcReleaseHelper.getPageDet(filter)
      .then((data) => {
  ...
  getFilteredData(filter) {
    sdlcReleaseHelper.getFilteredData(filter)
      .then((data) => {
        this.setState({
          arr_exportData: data,
          columnHeaders: {
...
{/* // table_column */}
                <td>{t.id}</td>
                <td>{t.proj_name}</td>
                <td>{t.release_name}</td>
                <td>{t.start_date}</td>
                <td>{t.end_date}</td>
                <td>{t.release_lead}</td>
                <td>{t.cycle_name}</td>
                  ...
                  c.clm_export == 13 && (
                    <div className={styles.excelcontainer}>
                      <ExportExcel
                        ...
                        fileName={"sdReleaseDet_" + moment().format("DDMMYYhhmmss")}
