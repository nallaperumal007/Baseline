...
import Component from "../../components/sdlcMgmt/sdProjDet";
import SdlcProjHelper from "../../helper/sdlcMgmt/sdProjDet";
// import alias_name from "../../helper/helper_source_name"
import TimelineComponent from "../../components/sdlcMgmt/sdProjDetAudit";
...
//	document.addEventListener('contextmenu', (e) => {e.preventDefault();});
  ...
  getPageDet(filter) {
    ...
    SdlcProjHelper.getPageDet(filter)
      .then((data) => {
  ...
  getFilteredData(filter) {
    SdlcProjHelper.getFilteredData(filter)
      .then((data) => {
        this.setState({
          arr_exportData: data,
          columnHeaders: {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <SideMenu tag="SDLC Project Details">
                  ...
                  c.clm_export == 13 && (
                    <div className={styles.excelcontainer}>
                      <ExportExcel
                        ...
                        fileName={"sdProjDet_" + moment().format("DDMMYYhhmmss")}
