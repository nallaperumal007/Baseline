...
import Component from "../../components/sdlcMgmt/sdModDet";
import SdlcModHelper from "../../helper/sdlcMgmt/sdModDet";
// import alias_name from "../../helper/helper_source_name"
import TimelineComponent from "../../components/sdlcMgmt/sdModDetAudit";
...
//	document.addEventListener('contextmenu', (e) => {e.preventDefault();});
  ...
  async getData() {
    ...
    try {
      ...
      arr_com_claim[0].clm_view == 3 &&
        (this.getPageDetails(filter), this.getFilteredData(filter));
  ...
  getPageDetails(filter) {
    const { com_id } = this.state;

    filter.com_id = com_id;

    SdlcModHelper.getPageDet(filter)
      .then((data) => {
  ...
  getFilteredData(filter) {
    SdlcModHelper.getFilteredData(filter)
      .then((data) => {
        this.setState({
          arr_exportData: data,
          columnHeaders: {
            ...
            // table_header1
                ...
                imp_status_name:"Implementation Status",
                  ...
                  c.clm_export == 13 && (
                    <div className={styles.excelcontainer}>
                      <ExportExcel
                        ...
                        fileName={"sdModDet_" + moment().format("DDMMYYhhmmss")}
