...
import Component from "../../components/sdlcMgmt/sdAcDet";
import SdlcAcHelper from "../../helper/sdlcMgmt/sdAcDet";
// import alias_name from "../../helper/helper_source_name"
import TimelineComponent from "../../components/sdlcMgmt/sdAcDetAudit";
...
//	document.addEventListener('contextmenu', (e) => {e.preventDefault();});
  ...
  getPageDet(filter) {
    ...
    SdlcAcHelper.getPageDet(filter)
      .then((data) => {
  ...
  getFilteredData(filter) {
    SdlcAcHelper.getFilteredData(filter)
      .then((data) => {
        this.setState({
          arr_exportData: data,
          columnHeaders: {
                  ...
                  c.clm_export == 13 && (
                    <div className={styles.excelcontainer}>
                      <ExportExcel
                        ...
                        fileName={"sdAcDet_" + moment().format("DDMMYYhhmmss")}
