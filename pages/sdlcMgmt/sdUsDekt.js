...
import Component from "../../components/sdlcMgmt/sdUsDet";
import SdlcUsHelper from "../../helper/sdlcMgmt/sdUsDet";
// import alias_name from "../../helper/helper_source_name"
import TimelineComponent from "../../components/sdlcMgmt/sdUsDetAudit";

export default class SdUsDetails extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
//	document.addEventListener('contextmenu', (e) => {e.preventDefault();});
  ...
  getPageDet(filter) {
    ...
    SdlcUsHelper.getPageDet(filter)
      .then((data) => {
  ...
  getFilteredData(filter) {
    SdlcUsHelper.getFilteredData(filter)
      .then((data) => {
        this.setState({
          arr_exportData: data,
          columnHeaders: {
            ...
            // table_header1
                id:"ID",
                us_name:"User Story Name",
                descr:"Description",
                feat_id:"Feature Name",
                us_as_a:"AS A",
                us_i_want:"I WANT",
                us_so_that:"SO THAT",
                us_bus_rational:"Business Rational",
                us_type:"User Story Type",
                templ_id:"Template ID",
                proj_imp_status_id:"Implementation Status",
...
{/* // table_column */}
                ...
                <td>{t.us_i_want}</td>
                <td>{t.us_so_that}</td>
                <td>{t.us_bus_rational}</td>
                <td>{t.us_type}</td>
                <td>{t.templ_id}</td>
                <td>{t.imp_status_name}</td>
                  ...
                  c.clm_export == 13 && (
                    <div className={styles.excelcontainer}>
                      <ExportExcel
                        ...
                        fileName={"sdUsDet_" + moment().format("DDMMYYhhmmss")}
