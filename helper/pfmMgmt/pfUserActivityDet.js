...
const PfUserActivityDet = {

    insertRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.post("/pfUserActivityDet/insertRecord", data, {
                headers: {
    ...
    updateRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.patch("/pfUserActivityDet/updateRecord", data, {
                headers: {
                    "x-access-token": global.config.accessToken,
                },
            })
	...
	getRecord: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/pfUserActivityDet/getRecord";
            const filterUrl = PfUserActivityDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                ...
                .then(async (res) => {
                    resolve(PfUserActivityDet.formatRecord(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
	...
	getPageDet: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/pfUserActivityDet/getPageDet";
            const filterUrl = PfUserActivityDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(PfUserActivityDet.formatPageDet(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
    ...
    getAuditData: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/pfUserActivityDet/getAudit";
            const filterUrl = PfUserActivityDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
    ...
    getFilteredData: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/pfUserActivityDet/getFilteredData";
            const filterUrl = PfUserActivityDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(PfUserActivityDet.formatFiltered(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
...
export default PfUserActivityDet;