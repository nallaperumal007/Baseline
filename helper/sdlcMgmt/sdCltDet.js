...
const SdCltDet = {
    ...
    insertRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.post("/sdCltDet/insertRecord", data, {
                headers: {
    ...
    updateRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.patch("/sdCltDet/updateRecord", data, {
                headers: {
                    "x-access-token": global.config.accessToken,
                },
            })
	...
	getRecord: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/sdCltDet/getRecord";
            const filterUrl = SdCltDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                ...
                .then(async (res) => {
                    resolve(SdCltDet.formatRecord(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
    ...
    getForDropDown: (filter) =>
        new Promise(function (resolve, reject) {
            ...
            API.get(`${baseUrl}?${filterUrl}`, {
                ...
                .then(async (res) => {
                    resolve(SdCltDet.formatdd(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
    ...
    getClientName: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/sdDdLookup/getClientName";
            const filterUrl = SdCltDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
	...
	getPageDet: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/sdCltDet/getPageDet";
            const filterUrl = SdCltDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(SdCltDet.formatPageDet(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
    ...
    getAuditData: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/sdCltDet/getAudit";
            const filterUrl = SdCltDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
    ...
    getFilteredData: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/sdCltDet/getFilteredData";
            const filterUrl = SdCltDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(SdCltDet.formatFiltered(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
