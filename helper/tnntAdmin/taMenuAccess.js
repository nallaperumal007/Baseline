...
const TaMenuAccess = {
    ...
    insertRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.post("/taMenuAccess/insertRecord", data, {
                headers: {
    ...
    updateRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.patch("/taMenuAccess/updateRecord", data, {
                headers: {
                    "x-access-token": global.config.accessToken,
                },
            })
	...
	getRecord: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/taMenuAccess/getRecord";
            const filterUrl = TaMenuAccess.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                ...
                .then(async (res) => {
                    resolve(TaMenuAccess.formatRecord(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
	...
	getPageDet: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/taMenuAccess/getPageDet";
            const filterUrl = TaMenuAccess.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(TaMenuAccess.formatPageDet(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
    ...
    getFilteredData: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/taMenuAccess/getFilteredData";
            const filterUrl = TaMenuAccess.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(TaMenuAccess.formatFiltered(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
	...
	getAuditData: (filter) =>
        new Promise(function (resolve, reject) {
        const baseUrl = "/taMenuAccess/getAudit";
        const filterUrl = TaMenuAccess.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
