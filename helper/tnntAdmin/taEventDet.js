...
const TaEventDet = {
    ...
    insertRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.post("/taEventDet/insertRecord", data, {
                headers: {
    ...
    updateRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.patch("/taEventDet/updateRecord", data, {
                headers: {
                    "x-access-token": global.config.accessToken,
                },
            })
    ...
    getRecord: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/taEventDet/getRecord";
            const filterUrl = TaEventDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                ...
                .then(async (res) => {
                    resolve(TaEventDet.formatRecord(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
    ...
    getPageDet: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/taEventDet/getPageDet";
            const filterUrl = TaEventDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(TaEventDet.formatPageDet(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
    ...
    getFilteredData: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/taEventDet/getFilteredData";
            const filterUrl = TaEventDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(TaEventDet.formatFiltered(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
	...
	getAuditData: (filter) =>
        new Promise(function (resolve, reject) {
        const baseUrl = "/taEventDet/getAudit";
        const filterUrl = TaEventDet.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
