...
const TaMenuGroup = {
    ...
    insertRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.post("/taMenuGroup/insertRecord", data, {
                headers: {
    ...
    updateRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.patch("/taMenuGroup/updateRecord", data, {
                headers: {
                    "x-access-token": global.config.accessToken,
                },
            })
	...
	getRecord: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/taMenuGroup/getRecord";
            const filterUrl = TaMenuGroup.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                ...
                .then(async (res) => {
                    resolve(TaMenuGroup.formatRecord(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
	...
	getPageDet: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/taMenuGroup/getPageDet";
            const filterUrl = TaMenuGroup.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(TaMenuGroup.formatPageDet(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
    ...
    getFilteredData: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/taMenuGroup/getFilteredData";
            const filterUrl = TaMenuGroup.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(TaMenuGroup.formatFiltered(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
	...
	getAuditData: (filter) =>
        new Promise(function (resolve, reject) {
        const baseUrl = "/taMenuGroup/getAudit";
        const filterUrl = TaMenuGroup.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
...
if (filter.menu_group !== undefined) {
    url += "menu_group=" + filter.menu_group + "&";
}
