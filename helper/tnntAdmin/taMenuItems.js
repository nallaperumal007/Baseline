...
const TaMenuItems = {
    ...
    insertRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.post("/taMenuItems/insertRecord", data, {
                headers: {
    ...
    updateRecord: (data) =>
        new Promise(function (resolve, reject) {
            API.patch("/taMenuItems/updateRecord", data, {
                headers: {
                    "x-access-token": global.config.accessToken,
                },
            })
	...
	getRecord: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/taMenuItems/getRecord";
            const filterUrl = TaMenuItems.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                ...
                .then(async (res) => {
                    resolve(TaMenuItems.formatRecord(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
	...
	getPageDet: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/taMenuItems/getPageDet";
            const filterUrl = TaMenuItems.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(TaMenuItems.formatPageDet(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
    ...
    getFilteredData: (filter) =>
        new Promise(function (resolve, reject) {
            const baseUrl = "/taMenuItems/getFilteredData";
            const filterUrl = TaMenuItems.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
                ...
                .then(async (res) => {
                    resolve(TaMenuItems.formatFiltered(res.data));
                })
                .catch((err) => {
                    reject(err);
                });
	...
	getAuditData: (filter) =>
        new Promise(function (resolve, reject) {
        const baseUrl = "/taMenuItems/getAudit";
        const filterUrl = TaMenuItems.getFilterUrl(filter);
            API.get(`${baseUrl}?${filterUrl}`, {
                headers: {
                    "x-access-token": global.config.accessToken,
...
if (filter.item_name !== undefined) {
    url += "item_name=" + filter.item_name + "&";
}
