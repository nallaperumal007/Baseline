      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.old_wfs_id_old !== data.old_wfs_id_new){
                 l_display_summary += 'Old Workflow status ID' + ' is changed from ' + data.old_wfs_id_old+ ' to: '+ data.old_wfs_id_new + ' '   ;
            }
            if (data.wfa_id_old !== data.wfa_id_new){
                 l_display_summary += 'Workflow Action ID' + ' is changed from ' + data.wfa_id_old+ ' to: '+ data.wfa_id_new + ' '   ;
            }
            if (data.next_wfs_id_old !== data.next_wfs_id_new){
                 l_display_summary += 'Next Workflow status ID' + ' is changed from ' + data.next_wfs_id_old+ ' to: '+ data.next_wfs_id_new + ' '   ;
            }
            if (data.access_role_users_list_old !== data.access_role_users_list_new){
                 l_display_summary += 'Access Role Users List' + ' is changed from ' + data.access_role_users_list_old+ ' to: '+ data.access_role_users_list_new + ' '   ;
            }
