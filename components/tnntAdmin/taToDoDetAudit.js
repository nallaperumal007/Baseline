...
import Audit_helper from "../../helper/tnntAdmin/taToDoDet";
...
export default class taToDoDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.task_title_old !== data.task_title_new){
                 l_display_summary += "Task Title" + " is changed from " + data.task_title_old+ " to: "+ data.task_title_new + " "   ;
               }
            if (data.task_descr_old !== data.task_descr_new){
                 l_display_summary += "Notes" + " is changed from " + data.task_descr_old+ " to: "+ data.task_descr_new + " "   ;
               }
            if (data.task_date_old !== data.task_date_new){
                 l_display_summary += "Date" + " is changed from " + data.task_date_old+ " to: "+ data.task_date_new + " "   ;
               }
            if (data.task_time_old !== data.task_time_new){
                 l_display_summary += "Time" + " is changed from " + data.task_time_old+ " to: "+ data.task_time_new + " "   ;
               }
            if (data.priority_id_old !== data.priority_id_new){
                 l_display_summary += "Priority" + " is changed from " + data.priority_id_old+ " to: "+ data.priority_id_new + " "   ;
               }
