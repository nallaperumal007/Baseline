      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.menu_sub_item_id_old !== data.menu_sub_item_id_new){
                 l_display_summary += 'Menu Sub Item ID' + ' is changed from ' + data.menu_sub_item_id_old+ ' to: '+ data.menu_sub_item_id_new + ' '   ;
            }
