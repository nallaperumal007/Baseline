...
import Audit_helper from "../../helper/tnntAdmin/taDmLog";
...
export default class taDmLogAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.order_type_id_old !== data.order_type_id_new){
                 l_display_summary += "Order Type" + " is changed from " + data.order_type_id_old+ " to: "+ data.order_type_id_new + " "   ;
               }
            if (data.usecase_id_old !== data.usecase_id_new){
                 l_display_summary += "Usecase" + " is changed from " + data.usecase_id_old+ " to: "+ data.usecase_id_new + " "   ;
               }
            if (data.upload_file_old !== data.upload_file_new){
                 l_display_summary += "Upload File" + " is changed from " + data.upload_file_old+ " to: "+ data.upload_file_new + " "   ;
               }
            if (data.data_validation_old !== data.data_validation_new){
                 l_display_summary += "Data Validation" + " is changed from " + data.data_validation_old+ " to: "+ data.data_validation_new + " "   ;
               }
            if (data.duplicate_old !== data.duplicate_new){
                 l_display_summary += "Duplicate" + " is changed from " + data.duplicate_old+ " to: "+ data.duplicate_new + " "   ;
               }
            if (data.override_old !== data.override_new){
                 l_display_summary += "Override" + " is changed from " + data.override_old+ " to: "+ data.override_new + " "   ;
               }
