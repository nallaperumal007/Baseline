...
import SampleHelper from "../../helper/tnntAdmin/taDmUc1";

export default class TaDmUc1Det extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
  ...
  getRecord() {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        ...
        int_student_id: data[0].student_id,
        text_student_name: data[0].student_name,
  ...
  async insertRecord() {
    ...
    try {
      ...
      //Validation
            if (int_student_id === undefined){
                 alertText += ".Student ID\n ";
            }
            if (text_student_name ===""){
                 alertText += ".Student Name\n ";
            }
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="number"
                                    value={int_student_id}
                                    onChange={(e) =>
                                    this.setState({
                                        int_student_id: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_student_name}
                                    onChange={(e) =>
                                    this.setState({
                                        text_student_name: e.target.value,
                                    })
                                    }
                                />
                                </div>
