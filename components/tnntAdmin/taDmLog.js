...
import SampleHelper from "../../helper/tnntAdmin/taDmLog";

export default class TaDmLog extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
  ...
  getRecord() {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        ...
        int_order_type_id: data[0].order_type_id,
        int_usecase_id: data[0].usecase_id,
        text_upload_file: data[0].upload_file,
        int_data_validation: data[0].data_validation,
        int_duplicate: data[0].duplicate,
        int_override: data[0].override,
  ...
  async insertRecord() {
    ...
    try {
      ...
      //Validation
            if (int_order_type_id === undefined || int_order_type_id === ""){
                 alertText += ".Order Type\n ";
            }
            if (int_usecase_id === undefined || int_usecase_id === ""){
                 alertText += ".Usecase\n ";
            }
      ...
      const data = {
        ...
        usecase_id: int_usecase_id,
        upload_file: text_upload_file,
        data_validation: int_data_validation,
        duplicate: int_duplicate,
        override: int_override,
  ...
  async updateRecord() {
    ...
    try {
      ...
      //Validation
            if (int_order_type_id === undefined){
                 alertText += ".Order Type\n ";
            }
            if (int_usecase_id === undefined){
                 alertText += ".Usecase\n ";
            }
             ...
             <div className={styles.sideWrapper}>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="number"
                                    value={int_order_type_id}
                                    onChange={(e) =>
                                    this.setState({
                                        int_order_type_id: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="number"
                                    value={int_usecase_id}
                                    onChange={(e) =>
                                    this.setState({
                                        int_usecase_id: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_upload_file}
                                    onChange={(e) =>
                                    this.setState({
                                        text_upload_file: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="number"
                                    value={int_data_validation}
                                    onChange={(e) =>
                                    this.setState({
                                        int_data_validation: e.target.value,
                                    })
                                    }
                                />
                                </div>
