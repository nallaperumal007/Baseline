...
import SampleHelper from "../../helper/tnntAdmin/taUserComClaim";
import UserHelper from "../../helper/user";
import TaskHelper from "../../helper/timeMgmt/tsTask";

export default class TaUserComClaim extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        this.setState({
          ...
          idSelectedUserName: data[0].user_name,
