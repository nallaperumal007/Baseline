...
import SampleHelper from "../../helper/tnntAdmin/taRoleUserDet";

export default class TaRoleUserDet extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        this.setState({
          ...
          text_role_name: data[0].role_name,
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_role_name}
                                    onChange={(e) =>
                                    this.setState({
                                        text_role_name: e.target.value,
                                    })
                                    }
                                />
                                </div>
