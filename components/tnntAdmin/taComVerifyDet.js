...
import SampleHelper from "../../helper/tnntAdmin/taComVerifyDet";

export default class TaComVerfifyDet extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        this.setState({
          ...
          int_old_wfs_id: data[0].old_wfs_id,
          int_wfa_id: data[0].wfa_id,
          int_next_wfs_id: data[0].next_wfs_id,
          text_access_role_users_list: data[0].access_role_users_list,
  ...
  async insertRecord() {
    ...
    try {
      ...
      const data = {
        ...
        com_id: int_com_id,
        old_wfs_id: int_old_wfs_id,
        wfa_id: int_wfa_id,
        next_wfs_id: int_next_wfs_id,
        access_role_users_list: text_access_role_users_list,
          ...
          <div>
            ...
            {/*// task_4 : build logic per column and specific to data type.*/}
             <div className={styles.sideWrapper}>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="number"
                                    value={int_old_wfs_id}
                                    onChange={(e) =>
                                    this.setState({
                                        int_old_wfs_id: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            <div className={styles.inputAlignment}>
                            <p>Next Workflow status ID:<span
                            style={{ color: "red", marginLeft: "3px", fontSize: "20px" }}
                            >
                            *
                            </span></p>
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="number"
                                    value={int_next_wfs_id}
                                    onChange={(e) =>
                                    this.setState({
                                        int_next_wfs_id: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_access_role_users_list}
                                    onChange={(e) =>
                                    this.setState({
                                        text_access_role_users_list: e.target.value,
                                    })
                                    }
                                />
                                </div>
                                ...
                                <div className={styles.viewField}>
                                <p>{text_access_role_users_list}</p>
                                </div>
                            )}
                            </div>
                        </div>
