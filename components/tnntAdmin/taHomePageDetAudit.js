...
import Audit_helper from "../../helper/tnntAdmin/taHomePageDet";
...
export default class taHomePageDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.hosting_date_old !== data.hosting_date_new){
                 l_display_summary += "Hosting Date" + " is changed from " + data.hosting_date_old+ " to: "+ data.hosting_date_new + " "   ;
               }
            if (data.banner_1_image_old !== data.banner_1_image_new){
                 l_display_summary += "Banner 1" + " is changed from " + data.banner_1_image_old+ " to: "+ data.banner_1_image_new + " "   ;
               }
            if (data.banner_2_image_old !== data.banner_2_image_new){
                 l_display_summary += "Banner 2" + " is changed from " + data.banner_2_image_old+ " to: "+ data.banner_2_image_new + " "   ;
               }
            if (data.banner_3_image_old !== data.banner_3_image_new){
                 l_display_summary += "Banner 3" + " is changed from " + data.banner_3_image_old+ " to: "+ data.banner_3_image_new + " "   ;
               }
