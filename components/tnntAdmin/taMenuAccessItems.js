...
import SampleHelper from "../../helper/tnntAdmin/taMenuAccessItems";

export default class TaMenuAccessItems extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        this.setState({
          ...
          int_menu_item_id: data[0].menu_item_id,
          int_menu_sub_item_id: data[0].menu_sub_item_id,
  ...
  async insertRecord() {
    ...
    try {
      ...
      const data = {
        ...
        menu_item_id: int_menu_item_id,
        menu_sub_item_id: int_menu_sub_item_id,
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="number"
                                    value={int_menu_item_id}
                                    onChange={(e) =>
                                    this.setState({
                                        int_menu_item_id: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="number"
                                    value={int_menu_sub_item_id}
                                    onChange={(e) =>
                                    this.setState({
                                        int_menu_sub_item_id: e.target.value,
                                    })
                                    }
                                />
                                </div>
