      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.role_id_old !== data.role_id_new){
                 l_display_summary += 'Role ID' + ' is changed from ' + data.role_id_old+ ' to: '+ data.role_id_new + ' '   ;
            }
            ...
            if (data.clm_view_old !== data.clm_view_new){
                 l_display_summary += 'Claim View' + ' is changed from ' + data.clm_view_old+ ' to: '+ data.clm_view_new + ' '   ;
            }
            if (data.clm_create_old !== data.clm_create_new){
                 l_display_summary += 'Claim Create' + ' is changed from ' + data.clm_create_old+ ' to: '+ data.clm_create_new + ' '   ;
            }
            if (data.clm_update_old !== data.clm_update_new){
                 l_display_summary += 'Claim Update' + ' is changed from ' + data.clm_update_old+ ' to: '+ data.clm_update_new + ' '   ;
            }
            if (data.clm_export_old !== data.clm_export_new){
                 l_display_summary += 'Claim Export' + ' is changed from ' + data.clm_export_old+ ' to: '+ data.clm_export_new + ' '   ;
            }
