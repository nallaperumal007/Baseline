...
import Audit_helper from "../../helper/tnntAdmin/hsRePoDet";
...
export default class hsRePoDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.repo_title_old !== data.repo_title_new){
                 l_display_summary += "Task Title" + " is changed from " + data.repo_title_old+ " to: "+ data.repo_title_new + " "   ;
               }
            if (data.repo_descr_old !== data.repo_descr_new){
                 l_display_summary += "Notes" + " is changed from " + data.repo_descr_old+ " to: "+ data.repo_descr_new + " "   ;
               }
            if (data.repo_status_old !== data.repo_status_new){
                 l_display_summary += "status" + " is changed from " + data.repo_status_old+ " to: "+ data.repo_status_new + " "   ;
               }
            if (data.user_name_old !== data.user_name_new){
                 l_display_summary += "Client Ref ID" + " is changed from " + data.user_name_old+ " to: "+ data.user_name_new + " "   ;
               }
