...
import SampleHelper from "../../helper/tnntAdmin/taUserDet";

export default class TaUserDet extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        this.setState({
          ...
          text_role_list: data[0].role_list,
          text_employee_id: data[0].employee_id,
  ...
  async insertRecord() {
    ...
    try {
      ...
      const data = {
        ...
        role_list: text_role_list,
        employee_id: text_employee_id,
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_role_list}
                                    onChange={(e) =>
                                    this.setState({
                                        text_role_list: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_employee_id}
                                    onChange={(e) =>
                                    this.setState({
                                        text_employee_id: e.target.value,
                                    })
                                    }
                                />
                                </div>
