...
import pfDdLookupHelper from "../../helper/pfmMgmt/pfDdLookup";
...
export default class TaWFEDet extends React.Component {
  ...
  getComId() {
    ...
    pfDdLookupHelper.getComId(filter)
      .then((data) => {
        this.setState({ arr_com_id: data });
      })
      .catch((err) => {
        console.log(err);
      });
