...
import SampleHelper from "../../helper/tnntAdmin/taDmUc2";

export default class TaDmUc2Det extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
  ...
  getRecord() {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        ...
        int_contact_id: data[0].contact_id,
        text_contact_name: data[0].contact_name,
  ...
  async insertRecord() {
    ...
    try {
      ...
      //Validation
            if (int_contact_id === undefined){
                 alertText += ".Contact ID\n ";
            }
            if (text_contact_name ===""){
                 alertText += ".contact Name\n ";
            }
      ...
      const data = {
        ...
        contact_id: int_contact_id,
        contact_name: text_contact_name,
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="number"
                                    value={int_contact_id}
                                    onChange={(e) =>
                                    this.setState({
                                        int_contact_id: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_contact_name}
                                    onChange={(e) =>
                                    this.setState({
                                        text_contact_name: e.target.value,
                                    })
                                    }
                                />
                                </div>
