...
import Audit_helper from "../../helper/tnntAdmin/taDmUc2";
...
export default class taDmUc2Audit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.contact_id_old !== data.contact_id_new){
                 l_display_summary += "Contact ID" + " is changed from " + data.contact_id_old+ " to: "+ data.contact_id_new + " "   ;
               }
            if (data.contact_name_old !== data.contact_name_new){
                 l_display_summary += "contact Name" + " is changed from " + data.contact_name_old+ " to: "+ data.contact_name_new + " "   ;
               }
