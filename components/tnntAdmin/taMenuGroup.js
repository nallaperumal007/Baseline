...
import SampleHelper from "../../helper/tnntAdmin/taMenuGroup";

export default class TaMenuGroup extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        this.setState({
          ...
          text_menu_group: data[0].menu_group,
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_menu_group}
                                    onChange={(e) =>
                                    this.setState({
                                        text_menu_group: e.target.value,
                                    })
                                    }
                                />
                                </div>
