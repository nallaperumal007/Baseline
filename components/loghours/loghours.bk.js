...
export default class Timesheet extends React.Component {
        ...
        this.state = {
            ...
            selectedBill:
                props.data?.billing == undefined || props.editable == false
                    ...
                    : props.data?.billing,
            selectedWbs:
                props.data?.wbs_name == undefined || props.editable == false
                    ? undefined
                    : props.data?.wbs_name,
            selectedProject:
                props.data?.project_name == undefined || props.editable == false
                    ? undefined
    ...
    getWBS() {
        LoghoursHelper.getWBS()
            .then((data) => {
                this.setState({ wbs: data });
            })
            .catch((err) => {
                console.log(err);
            });
