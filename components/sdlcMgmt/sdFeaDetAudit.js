...
import Audit_helper from "../../helper/sdlcMgmt/sdFeaDet";
...
export default class sdFeaDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.feat_name_old !== data.feat_name_new){
                 l_display_summary += "Feature Name" + " is changed from " + data.feat_name_old+ " to: "+ data.feat_name_new + " "   ;
               }
            if (data.descr_old !== data.descr_new){
                 l_display_summary += "Description" + " is changed from " + data.descr_old+ " to: "+ data.descr_new + " "   ;
               }
            if (data.mod_id_old !== data.mod_id_new){
                 l_display_summary += "Module Name" + " is changed from " + data.mod_id_old+ " to: "+ data.mod_id_new + " "   ;
               }
            if (data.feat_imp_status_id_old !== data.feat_imp_status_id_new){
                 l_display_summary += "Implementation Status" + " is changed from " + data.feat_imp_status_id_old+ " to: "+ data.feat_imp_status_id_new + " "   ;
               }
