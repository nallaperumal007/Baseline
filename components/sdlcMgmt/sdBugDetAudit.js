...
import Audit_helper from "../../helper/sdlcMgmt/sdBugDet";
...
export default class sdBugDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.summary_old !== data.summary_new){
                 l_display_summary += "Summary" + " is changed from " + data.summary_old+ " to: "+ data.summary_new + " "   ;
               }
            if (data.actual_result_old !== data.actual_result_new){
                 l_display_summary += "Actual Result" + " is changed from " + data.actual_result_old+ " to: "+ data.actual_result_new + " "   ;
               }
            if (data.expected_result_old !== data.expected_result_new){
                 l_display_summary += "Expected Result" + " is changed from " + data.expected_result_old+ " to: "+ data.expected_result_new + " "   ;
               }
            if (data.recreate_steps_old !== data.recreate_steps_new){
                 l_display_summary += "Recreation Steps" + " is changed from " + data.recreate_steps_old+ " to: "+ data.recreate_steps_new + " "   ;
               }
            if (data.reporter_remarks_old !== data.reporter_remarks_new){
                 l_display_summary += "Reporter Remarks" + " is changed from " + data.reporter_remarks_old+ " to: "+ data.reporter_remarks_new + " "   ;
               }
            if (data.release_id_old !== data.release_id_new){
                 l_display_summary += "Release ID" + " is changed from " + data.release_id_old+ " to: "+ data.release_id_new + " "   ;
               }
            if (data.bug_status_id_old !== data.bug_status_id_new){
                 l_display_summary += "Bug Status" + " is changed from " + data.bug_status_id_old+ " to: "+ data.bug_status_id_new + " "   ;
               }
