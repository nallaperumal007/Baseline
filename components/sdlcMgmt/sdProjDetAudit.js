...
import Audit_helper from "../../helper/sdlcMgmt/sdProjDet";
...
export default class sdProjDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.proj_name_old !== data.proj_name_new){
                 l_display_summary += "Project Name" + " is changed from " + data.proj_name_old+ " to: "+ data.proj_name_new + " "   ;
               }
