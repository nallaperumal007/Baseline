...
import Audit_helper from "../../helper/sdlcMgmt/sdAcDet";
...
export default class sdAcDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.ac_name_old !== data.ac_name_new){
                 l_display_summary += "User Story Name" + " is changed from " + data.ac_name_old+ " to: "+ data.ac_name_new + " "   ;
               }
            if (data.descr_old !== data.descr_new){
                 l_display_summary += "Description" + " is changed from " + data.descr_old+ " to: "+ data.descr_new + " "   ;
               }
            if (data.us_id_old !== data.us_id_new){
                 l_display_summary += "US Name" + " is changed from " + data.us_id_old+ " to: "+ data.us_id_new + " "   ;
               }
            if (data.ac_scenario_old !== data.ac_scenario_new){
                 l_display_summary += "Scenario" + " is changed from " + data.ac_scenario_old+ " to: "+ data.ac_scenario_new + " "   ;
               }
            if (data.ac_given_old !== data.ac_given_new){
                 l_display_summary += "Given" + " is changed from " + data.ac_given_old+ " to: "+ data.ac_given_new + " "   ;
               }
            if (data.ac_when_old !== data.ac_when_new){
                 l_display_summary += "When" + " is changed from " + data.ac_when_old+ " to: "+ data.ac_when_new + " "   ;
               }
            if (data.ac_then_old !== data.ac_then_new){
                 l_display_summary += "Then" + " is changed from " + data.ac_then_old+ " to: "+ data.ac_then_new + " "   ;
               }
            if (data.testing_type_id_old !== data.testing_type_id_new){
                 l_display_summary += "Testing Type" + " is changed from " + data.testing_type_id_old+ " to: "+ data.testing_type_id_new + " "   ;
               }
