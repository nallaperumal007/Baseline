...
import Audit_helper from "../../helper/sdlcMgmt/sdReleaseDet";
...
export default class sdReleaseDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.proj_id_old !== data.proj_id_new){
                 l_display_summary += "Project Name" + " is changed from " + data.proj_id_old+ " to: "+ data.proj_id_new + " "   ;
               }
            if (data.release_name_old !== data.release_name_new){
                 l_display_summary += "Release Name" + " is changed from " + data.release_name_old+ " to: "+ data.release_name_new + " "   ;
               }
            if (data.start_date_old !== data.start_date_new){
                 l_display_summary += "Start Date" + " is changed from " + data.start_date_old+ " to: "+ data.start_date_new + " "   ;
               }
            if (data.end_date_old !== data.end_date_new){
                 l_display_summary += "End Date" + " is changed from " + data.end_date_old+ " to: "+ data.end_date_new + " "   ;
               }
            if (data.release_lead_old !== data.release_lead_new){
                 l_display_summary += "Release Lead" + " is changed from " + data.release_lead_old+ " to: "+ data.release_lead_new + " "   ;
               }
            if (data.tc_id_old !== data.tc_id_new){
                 l_display_summary += "Test Cycle Name" + " is changed from " + data.tc_id_old+ " to: "+ data.tc_id_new + " "   ;
               }
