...
import Audit_helper from "../../helper/sdlcMgmt/sdTestCycleDet";
...
export default class sdTestCycleDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.cycle_name_old !== data.cycle_name_new){
                 l_display_summary += "Test Cycle Name" + " is changed from " + data.cycle_name_old+ " to: "+ data.cycle_name_new + " "   ;
               }
            ...
            if (data.test_lead_old !== data.test_lead_new){
                 l_display_summary += "Test Lead" + " is changed from " + data.test_lead_old+ " to: "+ data.test_lead_new + " "   ;
               }
