...
import Audit_helper from "../../helper/sdlcMgmt/sdModDet";
...
export default class sdModDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.mod_name_old !== data.mod_name_new){
                 l_display_summary += "Module Name" + " is changed from " + data.mod_name_old+ " to: "+ data.mod_name_new + " "   ;
               }
            ...
            if (data.mod_imp_status_id_old !== data.mod_imp_status_id_new){
                 l_display_summary += "Implementation Status" + " is changed from " + data.mod_imp_status_id_old+ " to: "+ data.mod_imp_status_id_new + " "   ;
               }
