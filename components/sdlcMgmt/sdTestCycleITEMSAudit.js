...
import Audit_helper from "../../helper/sdlcMgmt/sdTestCycleITEMS";
...
export default class sdTestCycleITEMSAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.AC_id_old !== data.AC_id_new){
                 l_display_summary += "Acceptance Name" + " is changed from " + data.AC_id_old+ " to: "+ data.AC_id_new + " "   ;
               }
            if (data.execut_status_id_old !== data.execut_status_id_new){
                 l_display_summary += "Execution Status" + " is changed from " + data.execut_status_id_old+ " to: "+ data.execut_status_id_new + " "   ;
               }
            if (data.attachment_1_old !== data.attachment_1_new){
                 l_display_summary += "Attachment one" + " is changed from " + data.attachment_1_old+ " to: "+ data.attachment_1_new + " "   ;
               }
            if (data.attachment_2_old !== data.attachment_2_new){
                 l_display_summary += "Attachment two" + " is changed from " + data.attachment_2_old+ " to: "+ data.attachment_2_new + " "   ;
               }
