...
import SampleHelper from "../../helper/pfmMgmt/pfOrdM1Stock";

export default class PfOrdM1Stock extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
  ...
  getRecord() {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        ...
        int_bill_id: data[0].bill_id,
        int_quantity_id: data[0].quantity_id,
  ...
  async insertRecord() {
    ...
    try {
      ...
      //Validation
            ...
            if (int_bill_id === undefined){
                 alertText += ".Bill Id\n ";
            }
            if (int_quantity_id === undefined){
                 alertText += ".Quantity\n ";
            }
          ...
          <div>
            ...
            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="number"
                                    value={int_quantity_id}
                                    onChange={(e) =>
                                    this.setState({
                                        int_quantity_id: e.target.value,
                                    })
                                    }
                                />
                                </div>
