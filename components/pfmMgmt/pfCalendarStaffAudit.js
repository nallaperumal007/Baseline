      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.d_type_old !== data.d_type_new){
                 l_display_summary += "Day Type" + " is changed from " + data.d_type_old+ " to: "+ data.d_type_new + " "   ;
               }
            if (data.log_hrs_old !== data.log_hrs_new){
                 l_display_summary += "Log Hours" + " is changed from " + data.log_hrs_old+ " to: "+ data.log_hrs_new + " "   ;
               }
            if (data.ts_list_old !== data.ts_list_new){
                 l_display_summary += "Timesheet List" + " is changed from " + data.ts_list_old+ " to: "+ data.ts_list_new + " "   ;
               }
            if (data.remarks_old !== data.remarks_new){
                 l_display_summary += "Remarks" + " is changed from " + data.remarks_old+ " to: "+ data.remarks_new + " "   ;
               }
