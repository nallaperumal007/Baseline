...
import Audit_helper from "../../helper/pfmMgmt/pfUserDet";
...
export default class pfUserDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.clt_password_old !== data.clt_password_new){
                 l_display_summary += "Client Password" + " is changed from " + data.clt_password_old+ " to: "+ data.clt_password_new + " "   ;
               }
            if (data.is_google_oath_old !== data.is_google_oath_new){
                 l_display_summary += "Is Google Auth" + " is changed from " + data.is_google_oath_old+ " to: "+ data.is_google_oath_new + " "   ;
               }
            if (data.first_attempt_old !== data.first_attempt_new){
                 l_display_summary += "First Attempt" + " is changed from " + data.first_attempt_old+ " to: "+ data.first_attempt_new + " "   ;
               }
            if (data.failed_attempt_cnt_old !== data.failed_attempt_cnt_new){
                 l_display_summary += "Failed Attempt Count" + " is changed from " + data.failed_attempt_cnt_old+ " to: "+ data.failed_attempt_cnt_new + " "   ;
               }
