      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.login_timestamp_old !== data.login_timestamp_new){
                 l_display_summary += 'Login Timestamp' + ' is changed from ' + data.login_timestamp_old+ ' to: '+ data.login_timestamp_new + ' '   ;
            }
            if (data.logoff_timestamp_old !== data.logoff_timestamp_new){
                 l_display_summary += 'Logoff Timestamp' + ' is changed from ' + data.logoff_timestamp_old+ ' to: '+ data.logoff_timestamp_new + ' '   ;
            }
