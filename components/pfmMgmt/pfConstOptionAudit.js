...
import Audit_helper from "../../helper/pfmMgmt/pfConstOption";
...
export default class pfConstOptionAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.const_type_id_old !== data.const_type_id_new){
                 l_display_summary += "Const Type Name" + " is changed from " + data.const_type_id_old+ " to: "+ data.const_type_id_new + " "   ;
               }
            if (data.option_name_old !== data.option_name_new){
                 l_display_summary += "Option Name" + " is changed from " + data.option_name_old+ " to: "+ data.option_name_new + " "   ;
               }
