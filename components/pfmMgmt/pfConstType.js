...
export default class PfConstType extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        this.setState({
          ...
          text_const_type_name : data[0].const_type_name,
  ...
  async insertRecord() {
    ...
    try {
      ...
      const data = {
        ...
        const_type_name : text_const_type_name ,
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_const_type_name }
                                    onChange={(e) =>
                                    this.setState({
                                        text_const_type_name : e.target.value,
                                    })
                                    }
                                />
                                </div>
