...
import SampleHelper from "../../helper/pfmMgmt/pfEmailTagValue";

export default class PfEmailTagValue extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
  ...
  getRecord() {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        ...
        int_email_id: data[0].email_id,
        text_tag_id: data[0].tag_id,
        text_tag_value: data[0].tag_value,
  ...
  async insertRecord() {
    ...
    try {
      ...
      const data = {
        ...
        email_id: int_email_id,
        tag_id: text_tag_id,
        tag_value: text_tag_value,
          ...
          <div>
            ...
            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_tag_value}
                                    onChange={(e) =>
                                    this.setState({
                                        text_tag_value: e.target.value,
                                    })
                                    }
                                />
                                </div>
