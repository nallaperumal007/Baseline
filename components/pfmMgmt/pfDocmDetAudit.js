...
import Audit_helper from "../../helper/pfmMgmt/pfDocmDet";
...
export default class pfDocmDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.docm_group_id_old !== data.docm_group_id_new){
                 l_display_summary += "Document Group ID" + " is changed from " + data.docm_group_id_old+ " to: "+ data.docm_group_id_new + " "   ;
               }
            if (data.docm_name_old !== data.docm_name_new){
                 l_display_summary += "Raised Date" + " is changed from " + data.docm_name_old+ " to: "+ data.docm_name_new + " "   ;
               }
            if (data.docm_template_url_old !== data.docm_template_url_new){
                 l_display_summary += "Template " + " is changed from " + data.docm_template_url_old+ " to: "+ data.docm_template_url_new + " "   ;
               }
            if (data.has_validity_old !== data.has_validity_new){
                 l_display_summary += "Has Validity" + " is changed from " + data.has_validity_old+ " to: "+ data.has_validity_new + " "   ;
               }
            if (data.stage_id_old !== data.stage_id_new){
                 l_display_summary += "Stage ID" + " is changed from " + data.stage_id_old+ " to: "+ data.stage_id_new + " "   ;
               }
