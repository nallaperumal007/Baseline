...
import Audit_helper from "../../helper/pfmMgmt/pfUserTokenDet";
...
export default class pfUserTokenDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.user_token_old !== data.user_token_new){
                 l_display_summary += "User Token" + " is changed from " + data.user_token_old+ " to: "+ data.user_token_new + " "   ;
               }
            ...
            if (data.updated_at_old !== data.updated_at_new){
                 l_display_summary += "Updated At" + " is changed from " + data.updated_at_old+ " to: "+ data.updated_at_new + " "   ;
               }
