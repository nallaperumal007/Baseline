...
import Audit_helper from "../../helper/pfmMgmt/pfUserActivityDet";
...
export default class pfUserActivityDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.ms_id_old !== data.ms_id_new){
                 l_display_summary += "Microservice Name" + " is changed from " + data.ms_id_old+ " to: "+ data.ms_id_new + " "   ;
               }
