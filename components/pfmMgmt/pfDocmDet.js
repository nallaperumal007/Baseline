...
import SampleHelper from "../../helper/pfmMgmt/pfDocmDet";

export default class PfDocmDet extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
  ...
  getRecord() {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        ...
        int_docm_group_id: data[0].docm_group_id,
        text_docm_name: data[0].docm_name,
        text_docm_template_url: data[0].docm_template_url,
        int_has_validity: data[0].has_validity,
        int_stage_id: data[0].stage_id,
  ...
  async insertRecord() {
    ...
    try {
      ...
      //Validation
            if (int_docm_group_id === undefined){
                 alertText += ".Document Group ID\n ";
            }
            if (text_docm_name ===""){
                 alertText += ".Raised Date\n ";
            }
            if (int_has_validity === undefined){
                 alertText += ".Has Validity\n ";
            }
      ...
      const data = {
        ...
        docm_group_id: int_docm_group_id,
        docm_name: text_docm_name,
        docm_template_url: text_docm_template_url,
        has_validity: int_has_validity,
        stage_id: int_stage_id,
          ...
          <div>
            ...
            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="number"
                                    value={int_docm_group_id}
                                    onChange={(e) =>
                                    this.setState({
                                        int_docm_group_id: e.target.value,
                                    })
                                    }
                                />
                                </div>
            ...
            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_docm_name}
                                    onChange={(e) =>
                                    this.setState({
                                        text_docm_name: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_docm_template_url}
                                    onChange={(e) =>
                                    this.setState({
                                        text_docm_template_url: e.target.value,
                                    })
                                    }
                                />
                                </div>
            ...
            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="number"
                                    value={int_has_validity}
                                    onChange={(e) =>
                                    this.setState({
                                        int_has_validity: e.target.value,
                                    })
                                    }
                                />
                                </div>
