...
import Audit_helper from "../../helper/pfmMgmt/pfDocMainDet";
...
export default class pfDocMainDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.module_id_old !== data.module_id_new){
                 l_display_summary += "Module Name" + " is changed from " + data.module_id_old+ " to: "+ data.module_id_new + " "   ;
               }
            if (data.usecase_name_old !== data.usecase_name_new){
                 l_display_summary += "Staff Name" + " is changed from " + data.usecase_name_old+ " to: "+ data.usecase_name_new + " "   ;
               }
            if (data.page_content_public_old !== data.page_content_public_new){
                 l_display_summary += "Page Content Public" + " is changed from " + data.page_content_public_old+ " to: "+ data.page_content_public_new + " "   ;
               }
            if (data.page_content_intern_old !== data.page_content_intern_new){
                 l_display_summary += "Page Content Internal" + " is changed from " + data.page_content_intern_old+ " to: "+ data.page_content_intern_new + " "   ;
               }
