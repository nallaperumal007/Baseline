...
import SampleHelper from "../../helper/pfmMgmt/pfStockM1User";

export default class PfStockM1User extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
          ...
          <div>
            ...
            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_component_name}
                                    onChange={(e) =>
                                    this.setState({
                                        text_component_name: e.target.value,
                                    })
                                    }
                                />
                                </div>
