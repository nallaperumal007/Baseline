...
import Audit_helper from "../../helper/pfmMgmt/pfMachineM1Clt";
...
export default class pfMachineM1CltAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.machine_id_old !== data.machine_id_new){
                 l_display_summary += "Machine Id" + " is changed from " + data.machine_id_old+ " to: "+ data.machine_id_new + " "   ;
               }
            if (data.clt_id_old !== data.clt_id_new){
                 l_display_summary += "Client Id" + " is changed from " + data.clt_id_old+ " to: "+ data.clt_id_new + " "   ;
               }
