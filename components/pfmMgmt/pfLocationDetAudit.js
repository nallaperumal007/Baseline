...
import Audit_helper from "../../helper/pfmMgmt/pfLocationDet";
...
export default class pfLocationDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.latitude_det_old !== data.latitude_det_new){
                 l_display_summary += "Latitude" + " is changed from " + data.latitude_det_old+ " to: "+ data.latitude_det_new + " "   ;
               }
            if (data.longitude_det_old !== data.longitude_det_new){
                 l_display_summary += "Longitude" + " is changed from " + data.longitude_det_old+ " to: "+ data.longitude_det_new + " "   ;
               }
            if (data.display_location_old !== data.display_location_new){
                 l_display_summary += "Display Location" + " is changed from " + data.display_location_old+ " to: "+ data.display_location_new + " "   ;
               }
            if (data.last_update_at_old !== data.last_update_at_new){
                 l_display_summary += "Last Update At" + " is changed from " + data.last_update_at_old+ " to: "+ data.last_update_at_new + " "   ;
               }
