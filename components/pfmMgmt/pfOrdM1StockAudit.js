...
import Audit_helper from "../../helper/pfmMgmt/pfOrdM1Stock";
...
export default class pfOrdM1StockAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.stock_id_old !== data.stock_id_new){
                 l_display_summary += "Stock Name" + " is changed from " + data.stock_id_old+ " to: "+ data.stock_id_new + " "   ;
               }
            if (data.bill_id_old !== data.bill_id_new){
                 l_display_summary += "Bill Id" + " is changed from " + data.bill_id_old+ " to: "+ data.bill_id_new + " "   ;
               }
            if (data.quantity_id_old !== data.quantity_id_new){
                 l_display_summary += "Quantity" + " is changed from " + data.quantity_id_old+ " to: "+ data.quantity_id_new + " "   ;
               }
