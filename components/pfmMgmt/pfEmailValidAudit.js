...
import Audit_helper from "../../helper/pfmMgmt/pfEmailValid";
...
export default class pfEmailValidAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.req_timestamp_old !== data.req_timestamp_new){
                 l_display_summary += "Request Timestamp" + " is changed from " + data.req_timestamp_old+ " to: "+ data.req_timestamp_new + " "   ;
               }
            if (data.resp_timestamp_old !== data.resp_timestamp_new){
                 l_display_summary += "Date" + " is changed from " + data.resp_timestamp_old+ " to: "+ data.resp_timestamp_new + " "   ;
               }
            if (data.resp_col1_old !== data.resp_col1_new){
                 l_display_summary += "Time" + " is changed from " + data.resp_col1_old+ " to: "+ data.resp_col1_new + " "   ;
               }
            if (data.resp_col2_old !== data.resp_col2_new){
                 l_display_summary += "Priority" + " is changed from " + data.resp_col2_old+ " to: "+ data.resp_col2_new + " "   ;
               }
