...
import Audit_helper from "../../helper/pfmMgmt/pfEmailTagValue";
...
export default class pfEmailTagValueAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.tag_id_old !== data.tag_id_new){
                 l_display_summary += "Tag ID" + " is changed from " + data.tag_id_old+ " to: "+ data.tag_id_new + " "   ;
               }
            if (data.tag_value_old !== data.tag_value_new){
                 l_display_summary += "Tag Value" + " is changed from " + data.tag_value_old+ " to: "+ data.tag_value_new + " "   ;
               }
