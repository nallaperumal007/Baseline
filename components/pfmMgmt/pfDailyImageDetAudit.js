      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.display_date_old !== data.display_date_new){
                 l_display_summary += 'Display Date' + ' is changed from ' + data.display_date_old+ ' to: '+ data.display_date_new + ' '   ;
            }
            if (data.image_url_old !== data.image_url_new){
                 l_display_summary += 'Image URL' + ' is changed from ' + data.image_url_old+ ' to: '+ data.image_url_new + ' '   ;
            }
