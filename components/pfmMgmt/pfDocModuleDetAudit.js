...
import Audit_helper from "../../helper/pfmMgmt/pfDocModuleDet";
...
export default class pfDocModuleDetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.module_name_old !== data.module_name_new){
                 l_display_summary += "Module Name" + " is changed from " + data.module_name_old+ " to: "+ data.module_name_new + " "   ;
               }
            if (data.access_list_old !== data.access_list_new){
                 l_display_summary += "Access List" + " is changed from " + data.access_list_old+ " to: "+ data.access_list_new + " "   ;
               }
