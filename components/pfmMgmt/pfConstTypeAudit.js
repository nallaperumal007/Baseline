...
import Audit_helper from "../../helper/pfmMgmt/pfConstType";
...
export default class pfConstTypeAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.const_type_name_old !== data.const_type_name_new){
                 l_display_summary += "Const Type Name" + " is changed from " + data.const_type_name_old+ " to: "+ data.const_type_name_new + " "   ;
               }
