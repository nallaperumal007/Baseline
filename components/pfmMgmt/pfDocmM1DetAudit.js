...
import Audit_helper from "../../helper/pfmMgmt/pfDocmM1Det";
...
export default class pfDocmM1DetAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.docm_type_id_old !== data.docm_type_id_new){
                 l_display_summary += "Document Type" + " is changed from " + data.docm_type_id_old+ " to: "+ data.docm_type_id_new + " "   ;
               }
            if (data.docm_old !== data.docm_new){
                 l_display_summary += "Document" + " is changed from " + data.docm_old+ " to: "+ data.docm_new + " "   ;
               }
