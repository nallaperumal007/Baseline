      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.req_det_old !== data.req_det_new){
                 l_display_summary += "Request Details" + " is changed from " + data.req_det_old+ " to: "+ data.req_det_new + " "   ;
               }
            if (data.res_det_old !== data.res_det_new){
                 l_display_summary += "Response Details" + " is changed from " + data.res_det_old+ " to: "+ data.res_det_new + " "   ;
               }
            if (data.event_timestamp_old !== data.event_timestamp_new){
                 l_display_summary += "Event Timestamp" + " is changed from " + data.event_timestamp_old+ " to: "+ data.event_timestamp_new + " "   ;
               }
            if (data.device_old !== data.device_new){
                 l_display_summary += "Device" + " is changed from " + data.device_old+ " to: "+ data.device_new + " "   ;
               }
