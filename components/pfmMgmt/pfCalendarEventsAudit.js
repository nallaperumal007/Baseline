      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.cl_date_old !== data.cl_date_new){
                 l_display_summary += 'Calendar Date' + ' is changed from ' + data.cl_date_old+ ' to: '+ data.cl_date_new + ' '   ;
            }
            if (data.cl_day_old !== data.cl_day_new){
                 l_display_summary += 'Calendar Day' + ' is changed from ' + data.cl_day_old+ ' to: '+ data.cl_day_new + ' '   ;
            }
            ...
            if (data.event_old !== data.event_new){
                 l_display_summary += 'Event' + ' is changed from ' + data.event_old+ ' to: '+ data.event_new + ' '   ;
            }
            if (data.start_time_old !== data.start_time_new){
                 l_display_summary += 'Start Time' + ' is changed from ' + data.start_time_old+ ' to: '+ data.start_time_new + ' '   ;
            }
            if (data.end_time_old !== data.end_time_new){
                 l_display_summary += 'End Time' + ' is changed from ' + data.end_time_old+ ' to: '+ data.end_time_new + ' '   ;
            }
            if (data.base_com_id_old !== data.base_com_id_new){
                 l_display_summary += 'Base Component Name' + ' is changed from ' + data.base_com_id_old+ ' to: '+ data.base_com_id_new + ' '   ;
            }
            if (data.base_com_rec_id_old !== data.base_com_rec_id_new){
                 l_display_summary += 'Base Component Record' + ' is changed from ' + data.base_com_rec_id_old+ ' to: '+ data.base_com_rec_id_new + ' '   ;
            }
