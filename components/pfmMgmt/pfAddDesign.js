...
import SampleHelper from "../../helper/pfmMgmt/pfConstType";

export default class pfAddDesig extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div>
            <p className={styles.title}>
              {editable === undefined ? "Create Designations" : editable ? "Update Designations" : "View Designations"}
            </p>
            <div className={styles.sideWrapper}>
              <div className={styles.leftWrapper}>
                <div className={styles.inputAlignment}>
                  <p>New Designation:<span style={{ color: "red", marginLeft: "3px", fontSize: "20px" }}>*</span></p>
                  {editable !== false ? (
                    <div className={styles.inputCustom}>
                      <CustomInput
                        ...
                        onChange={(e) =>
                          this.setState({
                            const_type_name: e.target.value,
                          })
                        }
                      />
                    </div>
