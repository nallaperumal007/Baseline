...
import SampleHelper from "../../helper/pfmMgmt/pfUserTokenDet";

export default class PfUserTokenDet extends React.Component {
  constructor(props) {
    super(props);
    const stateData = {
  ...
  getRecord() {
    ...
    SampleHelper.getRecord(filter)
      .then((data) => {
        ...
        text_user_token: data[0].user_token,
        text_created_at: data[0].created_at,
        text_updated_at: data[0].updated_at,
          ...
          <div>
            ...
            *
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_user_token}
                                    onChange={(e) =>
                                    this.setState({
                                        text_user_token: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_created_at}
                                    onChange={(e) =>
                                    this.setState({
                                        text_created_at: e.target.value,
                                    })
                                    }
                                />
                                </div>
                        ...
                        <div className={styles.leftWrapper}>
                            ...
                            {editable != false ? (
                                ...
                                <CustomInput
                                 input type="text"
                                    value={text_updated_at}
                                    onChange={(e) =>
                                    this.setState({
                                        text_updated_at: e.target.value,
                                    })
                                    }
                                />
                                </div>
