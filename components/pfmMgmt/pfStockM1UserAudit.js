...
import Audit_helper from "../../helper/pfmMgmt/pfStockM1User";
...
export default class pfStockM1UserAudit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      is_loading: false,
      ...
      <div className={styles.mainWrapper}>
        ...
        <div className={styles.wrapper} onClick={(e) => e.stopPropagation()}>
          ...
          <div className={styles.contentWrapper}>
            ...
            if (data.component_name_old !== data.component_name_new){
                 l_display_summary += "Component Name" + " is changed from " + data.component_name_old+ " to: "+ data.component_name_new + " "   ;
               }
            ...
            if (data.qty_old !== data.qty_new){
                 l_display_summary += "Quantity" + " is changed from " + data.qty_old+ " to: "+ data.qty_new + " "   ;
               }
