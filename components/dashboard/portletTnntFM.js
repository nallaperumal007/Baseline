          ...
          <table className={styles.table}>
            <thead>
              <tr className={styles.table}>
                <th colSpan="5" style={{ textAlign: "center" }}>Ticket Breakdown per Feature</th>
              </tr>
              <tr>
                <th>Module</th>
                <th>Feature ID(Name)</th>
                <th>Tot. Records</th>
                <th>Tot. Tickets</th>
                <th>Tot. Open</th>
            ...
            <tbody>
              ...
              {portlet2.map((row, index) => (
                <tr key={index}>
                  ...
                  <td>
                    <a href={`../../emMgmt/emContractDet?proj_id=1&status_id=1&stage_id=${row.stage_id}`} target="__blank">
                      {row.contract_count}
                    </a>
                  </td>
              ...
              {/* {portlet1.map((row, index) => (
                <tr key={index} className={styles.boldRow}>
                  <td >{row.status}</td>
                  <td>
                    <a href={`../../emMgmt/emStallDet?proj_id=1&rec_status_id=1`} target="__blank">
                      {row.total}
                    </a>
                  </td>
                  <td>{row.sq_meter}</td>
