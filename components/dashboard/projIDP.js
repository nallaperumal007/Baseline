          ...
          <table className={styles.table}>
            <thead>
              <tr className={styles.table}>
                <th colSpan="4" style={{ textAlign: "center" }}>2024-CJB-India Dairy Processing Expo</th>
              </tr>
              <tr>
              <th>Details</th>
              <th>Total</th>
            ...
            {portlet2.map((row, index) => (
                <tr key={index}>
                  ...
                  <td>
                    <a href={`../../emMgmt/emContractDet?proj_id=2&status_id=1&stage_id=${row.stage_id}`} target="__blank">
                      {row.contract_count}
                    </a>
                  </td>
              ...
              {portlet1.map((row, index) => (
                <tr key={index} className={styles.boldRow}>
                  <td >{row.status}</td>
                  <td>
                    <a href={`../../emMgmt/emStallDet?proj_id=2&rec_status_id=1`} target="__blank">
                      {row.total}
                    </a>
                  </td>
                  <td>{row.sq_meter}</td>
